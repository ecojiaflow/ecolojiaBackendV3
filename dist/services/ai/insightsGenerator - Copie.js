...
exports.insightsGenerator = exports.InsightsGenerator = void 0;
// PATH: backend/src/services/ai/insightsGenerator.ts
const Logger_1 = require("../../utils/Logger");
const log = new Logger_1.Logger('InsightsGenerator');
...
class InsightsGenerator {
    ...
    genFood(req, i, r, t, w) {
        ...
        // NOVA
        if (a.nova) {
            i.push(...TEMPLATES.food.nova[a.nova.group]);
            if (a.nova.group >= 3) {
                r.push(...TEMPLATES.food.reco.bad);
            }
            if (a.nova.additives?.some((ad) => ad.riskLevel === 'high')) {
        ...
        if (a.ultra?.markers?.some((m) => /hydrogén/i.test(m))) {
    ...
    genScore(score, i, r) {
        ...
        i.push(...TEMPLATES.general.score[t]);
        if (score < 60) {
            r.push('🔍 Comparez options');
        }
    }
}
exports.InsightsGenerator = InsightsGenerator;
exports.insightsGenerator = new InsightsGenerator();
